...
public class FereastraAdministrator {
    ...
    /**
     * Informatiile contului logat al administartorului
     * @param info
     */
    ...
    /**
     * Adaugarea si stergerea unor campuri in momentul apasari butonului de reset
     */
    private void addP()
    {
    ...
    /**
     * Adaugarea si stergerea unor campuri in momentul apasari butonului de confirmare resetare
     */
    private  void addP2()
    {
        profil.remove(profilAdmin);
    ...
    /**
     * Metoda pentru resetarea parolei, prezinta validarea contului
     * @param info
     * @param p
     * @param s
     * @param pN
    ...
    /**
     * Metoda de setare a parolei in baza de date
     * @param info
     * @param email
     * @param p
     */
    ...
    {
        ResultSet r = null;
        String url = "jdbc:sqlserver://vasi\\sqlexpress;databaseName=Biblioteca"; //url
        String username = "VasiMaris"; // nume
        String password = "10022040Vv"; // parola
    ...
    /**
     * Setarea actiuni in momentul in care sageata de la mouse se afla deasupra
     * @param d
     * @param p1
     * @param x
     * @param i
    ...
    /**
     * Setarea numerelor afisate in cele 3 categorii
     * @param info
     */
    ...
    /**
     * Setarea actiunii in momentul a celor trei carduri
     * @param d
     * @param p1
     * @param x
     * @param i
    ...
    /**
     * Setarea tabelului de imprumuturi
     */
    ...
    /**
     * Setarea tabelului de intarzieri
     */
    ...
    /**
     * Setarea aspectului pentru barea de derulare
     * @param newColor
     * @return
     */
